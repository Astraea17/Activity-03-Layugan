import layugan_script_1_stat as script_1
import layugan_script_2_ev as script_2

"""
Pokemon: Piplup
Level = 50
Nature: Impish(inc. Stat in Speed, while dec. stat in Sp.Atk)
Based Stats:
    Hp: 53 (iv = 27, ev = 109)
	Attack: 51 (iv = 17, ev = 75)
	Defense: 53 (iv = 10, ev = 78)
	Sp. Atk: 61 (iv = 25, ev = 50)
	Sp.Def: 56 (iv = 29 , ev = 60)
	Speed: 40 (iv = 10, ev = 138)
"""

iv = [0,0,0,0,0,0]
ev = [0,0,0,0,0,0]
nature = [1,1,1.1,0.9,1,1]
base = [0,0,0,0,0,0]
ivcal = [0,0,0,0,0,0]
evcal = [0,0,0,0,0,0]
...
def statsCalculation():
    ...
    print("\nPokemon Stats\n")
    print("Nature: Impish(inc. Stat in Speed, while dec. stat in Sp.Atk)")
...
def singleStats():
    ...
    while True:
        ...
        if opt == 1:
            ...
            print("Pokemon's nature: Impish(inc. Stat in Speed, while dec. stat in Sp.Atk)")
